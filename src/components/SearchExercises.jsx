...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      <Typography fontWeight={600} sx={{ fontSize: { lg: '35px', xs: '30px' } }} mb="49px" textAlign="center">
      ...
      <Box sx={{ position: 'relative', width: "100%", p: '20px', height:'300px' }}>
        <HorizontalScrollbar setBodyPart={setBodyPart} bodyPart={bodyPart} isBodyParts/>
      </Box>
    </Stack>
  );
};
